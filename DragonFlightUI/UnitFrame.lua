...
PartyMemberFrame1HealthBar:SetPoint("CENTER", 37, -3)
PartyMemberFrame1HealthBar:SetWidth(88)
...
PartyMemberFrame1ManaBar:SetHeight(8)
...
PartyMemberFrame2HealthBar:SetPoint("CENTER", 37, -3)
PartyMemberFrame2HealthBar:SetWidth(88)
...
PartyMemberFrame2ManaBar:SetHeight(8)
...
PartyMemberFrame3HealthBar:SetPoint("CENTER", 37, -3)
PartyMemberFrame3HealthBar:SetWidth(88)
...
PartyMemberFrame3ManaBar:SetHeight(8)
...
PartyMemberFrame4HealthBar:SetPoint("CENTER", 37, -3)
PartyMemberFrame4HealthBar:SetWidth(88)
...
PartyMemberFrame4ManaBar:SetHeight(8)
